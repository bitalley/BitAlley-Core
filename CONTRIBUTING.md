Contributing to BITALLEY Core
============================

The BITALLEY Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BITALLEY Core project, and is not to be
confused with overall BAC Network Protocol consensus changes.

Whether a pull request is merged into BITALLEY Core rests with the project merge
...
The project leader is the release manager for each BITALLEY Core release.
