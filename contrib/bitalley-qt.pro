...
RESOURCES += src/qt/bitalley.qrc src/qt/bitalley_locale.qrc

TRANSLATIONS += src/qt/locale/bitalley_bg.ts \
                src/qt/locale/bitalley_de.ts \
                src/qt/locale/bitalley_en.ts \
                src/qt/locale/bitalley_es.ts \
                src/qt/locale/bitalley_fi.ts \
                src/qt/locale/bitalley_fr.ts \
                src/qt/locale/bitalley_it.ts \
                src/qt/locale/bitalley_ja.ts \
                src/qt/locale/bitalley_pl.ts \
                src/qt/locale/bitalley_pt.ts \
                src/qt/locale/bitalley_ru.ts \
                src/qt/locale/bitalley_sk.ts \
                src/qt/locale/bitalley_sv.ts \
                src/qt/locale/bitalley_vi.ts \
                src/qt/locale/bitalley_zh_CN.ts \
                src/qt/locale/bitalley_zh_TW.ts
