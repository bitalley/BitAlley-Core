...
In order to support loading of multiple wallets in bitalley-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitalley.cpp.
...
Changes to bitalley.cpp
----------------------
bitalley.cpp is the entry point into bitalley-qt, and as such, will require some minor modifications to provide hooks for
