BITALLEY Core version *3.1.1* is now available from:  <https://github.com/bitalley-project/bitalley/releases>
...
Please report bugs using the issue tracker at github: <https://github.com/bitalley-project/bitalley/issues>

Non-Mandatory Update
==============

BITALLEY Core v3.1.1 is a non-mandatory update to address bugs and introduce minor enhancements that do not require a network change.
