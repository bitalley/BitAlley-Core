...
```
./bitalleyd -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=dnetzj6l4cvo2fxy.onion:989
```

In a typical situation, this suffices to run behind a Tor proxy:
```
./bitalleyd -proxy=127.0.0.1:9050
```
...
HiddenServicePort 989 127.0.0.1:31992
...
your bitalleyd's P2P listen port (31992 by default).
```
-externalip=X   You can tell bitalley about its publicly reachable address using
                this option, and this can be a .onion address. Given the above
                configuration, you can find your onion address in
                /var/lib/tor/bitalley-service/hostname. Onion addresses are given
...
```
./bitalleyd -proxy=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:989 -listen
```
...
and open port 31992 on your firewall (or use -upnp).

If you only want to use Tor to reach onion addresses, but not use it as a proxy
for normal IPv4/IPv6 communication, use:
```
./bitalleyd -onion=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:989 -discover
```
