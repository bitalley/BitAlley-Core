...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Bitalley Core bitalley-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitalley-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitalley transaction") + "\n" +
                               "  bitalley-tx [options] -create [commands]   " + _("Create hex-encoded bitalley transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitalley transaction
