                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BITALLEY Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BAC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitalley: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBAC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BITALLEY Core"), this);
    aboutAction->setStatusTip(tr("Show information about BITALLEY Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BAC"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BAC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BAC addresses"));
    ...
    openAction->setStatusTip(tr("Open a BAC: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BITALLEY Core help message to get a list with possible BAC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BITALLEY Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BAC network", "", count));
}
...
{
    QString strTitle = tr("BITALLEY Core"); // default title
