...
/* Bitalley GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BAC"
#define QAPP_ORG_DOMAIN "bitalley.org"
#define QAPP_APP_NAME_DEFAULT "BAC-Qt"
#define QAPP_APP_NAME_TESTNET "BAC-Qt-testnet"
