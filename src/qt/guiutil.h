...
/** Utility functions used by the BAC Qt UI.
 */
namespace GUIUtil
{
...
// Render BAC addresses in monospace font
...
// Parse "bitalley:" URI into recipient object, return true on successful parsing
