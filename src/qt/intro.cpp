...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BITALLEY Core"),
     ...
     * override -datadir in the bitalley.conf file in the default data directory
     * (to be consistent with bitalleyd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
