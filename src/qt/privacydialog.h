...
public:
    ...
    void setZBitalleyControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzBAC_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzBAC_clicked();
    void on_pushButtonZBitalleyControl_clicked();
