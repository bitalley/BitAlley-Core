...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BAC features */
        {"bitalley", "masternode", &masternode, true, true, false},
        {"bitalley", "listmasternodes", &listmasternodes, true, true, false},
        {"bitalley", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitalley", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitalley", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bitalley", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bitalley", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"bitalley", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitalley", "masternodedebug", &masternodedebug, true, true, false},
        {"bitalley", "startmasternode", &startmasternode, true, true, false},
        {"bitalley", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitalley", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitalley", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitalley", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitalley", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitalley", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitalley", "mnbudget", &mnbudget, true, true, false},
        {"bitalley", "preparebudget", &preparebudget, true, true, false},
        {"bitalley", "submitbudget", &submitbudget, true, true, false},
        {"bitalley", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitalley", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitalley", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitalley", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitalley", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitalley", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitalley", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitalley", "checkbudgets", &checkbudgets, true, true, false},
        {"bitalley", "mnsync", &mnsync, true, true, false},
        {"bitalley", "spork", &spork, true, true, false},
        {"bitalley", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> bitalley-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:31993/\n";
}
