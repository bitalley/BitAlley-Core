...
#else
/**
 * The Secp256k1 curve has an enbitalleyrphism, where lambda * (x, y) = (beta * x, y), where
 ...
 * when decomposing the scalar for an enbitalleyrphism-based point multiplication.
 *
