...
#ifndef BAC_ZBACWALLET_H
#define BAC_ZBACWALLET_H
...
public:
    CzBACWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZBAC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBAC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //BAC_ZBACWALLET_H
